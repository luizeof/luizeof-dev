...
> O FLUI é um kit de widgets Open Source para o [Flutter](/blog/categories/flutter/) que possui muitos widgets de interface do usuário de alta qualidade, fornecendo recursos e funções mais avançados para melhorar a eficiência do desenvolvimento.
